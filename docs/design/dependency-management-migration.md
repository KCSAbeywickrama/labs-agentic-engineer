...
| 6 | **Provisioning-as-issues + funnel gates + declarative wiring** — real `aep:provision` adapters (the crux) | 🟢 green | ✅ CODE DONE (6.1–6.4 committed + unit/arch green + OpenAPI regen) + **routes-live verified on the OC 1.1.1 cluster**; full live behavioral e2e (all 4 kinds through deploy) folds into the Phase 8 fresh-cluster gate |
