...
# http://localhost:8091 is the legacy-console escape hatch during the #98
# transition — same aep-console-client, different origin, so it needs its
# own allowOrigins entry or the token-endpoint preflight fails.
CORS_PATCH=$(cat <<EOF
