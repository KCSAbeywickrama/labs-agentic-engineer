...
// Mock the externalResources module before importing ExternalResourceValues
...
import { ExternalResourceValues } from './ExternalResourceValues';
...
describe('ExternalResourceValues', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  describe('submit calls externalResourcesApi.saveValues with correct args', () => {
    it('calls saveValues(projectId, dep.name, { development: {...} }) and shows hint + calls onSaved', async () => {
      vi.mocked(externalResourcesModule.externalResourcesApi.saveValues).mockResolvedValue(undefined);
      ...
      await waitFor(() => {
        expect(externalResourcesModule.externalResourcesApi.saveValues).toHaveBeenCalledWith(
          'my-project',
          'payment-gateway',
          {
            development: {
    ...
    it('shows server error on failure', async () => {
      ...
      vi.mocked(externalResourcesModule.externalResourcesApi.saveValues).mockRejectedValue(
