...
import "github.com/wso2/aep/aep-api/internal/contracts/taskmeta"
...
// class exactly once.
func (r *Registry) Register(class taskmeta.ExecutorClass, e Executor) {
	r.byClass[class] = e
}
...
func (r *Registry) Lookup(class taskmeta.ExecutorClass) (Executor, bool) {
