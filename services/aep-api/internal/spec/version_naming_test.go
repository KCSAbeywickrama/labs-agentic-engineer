...
// A tag cut before versions were named carries the same subject, but a mirror
// that lost the annotation still has to be recognisable.
func TestVersionTagsAcceptLegacyNumberedNames(t *testing.T) {
