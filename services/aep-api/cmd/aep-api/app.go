...
// watchers to launch. Bootstrap side effects (migrations, seeds) already ran
...
// buildApp wires the entire service graph from config + an open DB and returns
...
func buildApp(cfg config.Config, db *gorm.DB) (*App, error) {
	var err error
