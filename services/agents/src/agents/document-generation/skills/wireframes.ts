...
// `@aep/excalidraw-dsl` is the single workspace copy of the DSL → Excalidraw
// compiler (legacy per-project duplicates are gone) — see its module header.
import { dslToExcalidraw } from "@aep/excalidraw-dsl";
