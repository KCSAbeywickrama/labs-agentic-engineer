...
/**
 * Reference documents (#383/#384) are user uploads under this folder — inputs
 * to the spec, never collaboratively-edited spec content. They stay out of the
 * room in BOTH directions: never seeded (a binary file seeded as text renders
 * as garbage), and never flushed (writing one back as text destroys the
 * committed file — a real PDF in git became its own base64 this way).
 */
