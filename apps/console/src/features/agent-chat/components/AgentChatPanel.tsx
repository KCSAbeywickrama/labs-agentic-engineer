...
export function AgentChatPanel({
  ...
  useEffect(() => {
    ...
    // The requirements seed KNOWS grilling applies — inline the skill up front
    // (#335 latency): the agents service skips the model's loadSkill step.
    sendRef.current(
      instructionFor(autoGenerate, org, projectName),
      autoGenerate === "requirements" ? { eagerSkills: ["grilling"] } : undefined,
    );
    onAutoGenerated?.();
