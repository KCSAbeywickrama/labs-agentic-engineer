...
export function AgentChatPanel({
  ...
  const { messages, isSending, activeTurnId, send, answer, newConversation } = useAgentChat(
    org,
    projectName,
  );
  ...
  // ask_question cards (ADR-0012): a card is live only while unanswered and not
  // superseded by a later delivered user message. One O(n) pass per log change.
        ...
        <Box ref={contentRef}>
          {feed.length === 0 ? (
            ...
            <MessageList
              ...
              questionCard={{ answerableIds, busy: isSending, onAnswer: answer }}
            />
          )}
        </Box>
      </Box>
